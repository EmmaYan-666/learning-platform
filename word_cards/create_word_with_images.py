...
# 单词对应的数据
word_data = {
    "Dog": {"color": "#FF8C00", "bg": "FFF8DC", "cn": "小狗"},
    "Cat": {"color": "#FFB6C1", "bg": "FFF0F5", "cn": "小猫"},
    "Mouse": {"color": "#A9A9A9", "bg": "F5F5F5", "cn": "老鼠"},
    "Lion": {"color": "#FFD700", "bg": "FFFACD", "cn": "狮子"},
    "Leopard": {"color": "#CD853F", "bg": "FAEBD7", "cn": "豹子"},
    "Apple": {"color": "#DC143C", "bg": "FFE4E1", "cn": "苹果"},
    "Cheese": {"color": "#FFD700", "bg": "FFFACD", "cn": "奶酪"},
    "Bread": {"color": "#DEB887", "bg": "FAEBD7", "cn": "面包"},
    "Lollipop": {"color": "#FF69B4", "bg": "FFE4E6", "cn": "棒棒糖"},
    "Milk": {"color": "#87CEEB", "bg": "E6F3FF", "cn": "牛奶"},
    "Yogurt": {"color": "#E91E63", "bg": "FCE4EC", "cn": "酸奶"},
    "Elephant": {"color": "#708090", "bg": "F5F5F5", "cn": "大象"},
    "Donut": {"color": "#FF69B4", "bg": "FFE4E6", "cn": "甜甜圈"}
}

# Emoji映射（Milk和Yogurt使用特殊emoji）
emoji_map = {
    "Dog": "🐕",
    "Cat": "🐱", 
    "Mouse": "🐭",
...
def create_card_document_with_images():
    """创建使用图片的单词卡片文档"""
    doc = Document()
    ...
    diff_items = [
        "Milk（牛奶）- 玻璃杯装，白色液体，可以直接喝",
        "Yogurt（酸奶）- 碗装半固体，需要用勺子吃"
    ]
    ...
    print(f"🖼️ 牛奶和酸奶使用自定义图片")
    return output_path

if __name__ == "__main__":
    create_card_document_with_images()
